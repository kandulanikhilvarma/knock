...
const styles = StyleSheet.create({
  ...
  tagTxt: { fontFamily: font.te, fontSize: type.chip, color: colors.ink2 },
  coinRow: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: space.sm,
  ...
  coinTxt: { fontFamily: font.bold, fontSize: 9, color: colors.gold },
  coinLabel: { flex: 1, fontFamily: font.te, fontSize: type.chip, color: colors.inkMuted, lineHeight: 15 },
});
